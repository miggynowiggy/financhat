    ...
    body: {
      pdfFile: pdfFile
        ? {
            ...
            data: pdfFile ? Buffer.from(pdfFile.data).toString("base64") : null,
          }
        : null,
    },
    onResponse: () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <Card className="w-full max-w-3xl shadow-lg">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-2 w-full">
            ...
            <TabsTrigger value="chat" className="flex items-center gap-2" disabled={!pdfFile}>
            ...
            <CardContent className="pt-6">
              <div className="text-center mb-6">
                <p className="text-sm text-gray-500 mb-4">
                  Upload your bank statement to analyze and chat about your finances. Your data stays private and is
                  never stored on our servers.
                </p>

                <div className="flex items-center justify-center gap-2 mb-4">
                  <FileText className="h-5 w-5 text-blue-500" />
                  <span className="text-sm font-medium">Supports password-protected PDFs</span>
          ...
          <TabsContent value="chat" className="p-0">
            <CardContent className="h-[400px] overflow-y-auto pt-6 px-4">
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center text-gray-500">
                  <FileText className="h-12 w-12 mb-4 text-gray-300" />
                  <p>Your bank statement is ready for analysis.</p>
                  <p className="text-sm mt-2">Ask questions about your finances below.</p>
                </div>
              ) : (
      ...
      <div className="mt-4 text-xs text-gray-500 max-w-3xl text-center">
        <p>
          Your data is processed locally and never stored on our servers. We use Claude by Anthropic, a privacy-first AI
